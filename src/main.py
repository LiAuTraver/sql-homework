...
def confirm_edit():
    isbn = cast(str, flask.request.form.get("isbn"))
    name = cast(str, flask.request.form.get("name"))
    description = cast(str, flask.request.form.get("description"))
    publish_date = cast(datetime, flask.request.form.get("publish_date"))
